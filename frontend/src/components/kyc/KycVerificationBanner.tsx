...
import { AlertCircle, X, CheckCircle, Clock, XCircle } from 'lucide-react';
...
export function KycVerificationBanner({
  ...
  if (kycStatus === 'verified' && (!kycExpiry || new Date(kycExpiry) > new Date())) {
    return null;
  }
    ...
    switch (kycStatus) {
      case 'unverified':
        return {
          ...
          message: 'Complete identity verification to create escrows over $10,000.',
      ...
      case 'pending':
        return {
          ...
          message: 'Your identity verification is being processed. This usually takes 1-2 business days.',
          actionText: null,
          showAction: false,
        };
      case 'rejected':
        return {
          ...
          message: 'Your identity verification was not approved. Please contact support for assistance.',
      ...
      case 'expired':
        return {
          ...
          message: 'Your identity verification has expired. Please verify again to continue.',
