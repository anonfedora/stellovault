    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6H2.25M3.75 4.5h16.5M3.75 4.5v-.75A.75.75 0 0 1 4.5 3h15a.75.75 0 0 1 .75.75v.75M20.25 4.5v.75a.75.75 0 0 1-.75.75H21M20.25 4.5h-16.5m16.5 0v10.5a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V4.5m16.5 0h.75a.75.75 0 0 1 .75.75v10.5a.75.75 0 0 1-.75.75H21M3.75 4.5h-.75a.75.75 0 0 0-.75.75v10.5c0 .414.336.75.75.75H3"
        />
      </svg>
    ),
  },
        ...
        <nav className="flex-1 px-4 py-4 space-y-1">
          {NAVIGATION.map((item) => {
            ...
            return (
              ...
              >
                <span
                  className={`mr-3 ${isActive ? "text-indigo-700 dark:text-indigo-300" : "text-gray-400 dark:text-gray-500"}`}
                >
                  {item.icon}
                </span>
                {item.name}
