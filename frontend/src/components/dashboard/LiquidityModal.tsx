...
export function LiquidityModal({
  ...
  // Keyboard: Escape closes modal; trap focus
  useEffect(() => {
    if (!isOpen) return;
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`w-4 h-4 text-gray-400 transition-transform ${tokenMenuOpen ? 'rotate-180' : ''}`}
                    />
                  </button>
    ...
    <div className="p-5 space-y-4">
      ...
      {isLargeTx && (
        ...
        >
          ...
          <span>
            <strong>Large transaction:</strong> You are about to {tab} {amount} {token.code}.
    ...
    <div className="p-5 flex flex-col items-center gap-4 text-center">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
          {amount} {token.code}{' '}
          {tab === 'deposit' ? 'deposited into' : 'withdrawn from'} the vault.
        </p>
      </div>
...
function Row({
  ...
  return (
    <div className="flex items-center justify-between px-4 py-2.5">
      ...
      <dd
        className={`font-medium ${highlight ? 'text-blue-600 dark:text-blue-400' : 'text-gray-900 dark:text-gray-100'}`}
      >
        {value}
      </dd>
    </div>
